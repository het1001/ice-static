      ...
      <Row gutter={16}>
        ...
        <Col span={4} key={index + "dd" + 1}>
          <FormItem
            ...
            wrapperCol={{ span: 14 }}
            label="进价（件）">
            <InputNumber style={{width:72}} size="small" step={0.01} max={99999.99} onChange={this.handleNumChange.bind(this, 'pricePi', comIn.key)} /> 元
          </FormItem>
        </Col>
        ...
        <Col span={4} key={index + "bb" + 1}>
          <FormItem
            ...
            wrapperCol={{ span: 18 }}
            label="数量">
            <InputNumber style={{width:52}} size="small" step={1} max={99999} onChange={this.handleNumChange.bind(this, 'num', comIn.key)} /> 件
          </FormItem>
        </Col>
...
export default Form.create()(ComInForm);
