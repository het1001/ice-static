                    ...
                    <Form>
                        <FormItem
                          ...
                          label="姓名"
													required
                        >
                            <Input placeholder="输入名称" size="default" value={this.state.name} onChange={this.onInputChange.bind(this, 'name')} />
                        </FormItem>
                    </Form>
										<Form>
											<FormItem
												...
												label="唯一标识"
											>
												<Input placeholder="输入唯一标识" size="default" value={this.state.uniqueKey} onChange={this.onInputChange.bind(this, 'uniqueKey')} />
											</FormItem>
										</Form>
										<Form>
											<FormItem
												...
												required
											>
												<Input placeholder="输入手机号" size="default" value={this.state.phone} onChange={this.onInputChange.bind(this, 'phone')} />
											</FormItem>
										</Form>
                    <Form>
                        <FormItem
